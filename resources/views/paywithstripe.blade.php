...
{{ csrf_field() }}
 ...
 <label class='control-label'>N° de Carte</label>
 ...
 <input class='form-control card-expiry-year' placeholder='YYYY' size='4' type='hidden' name='amount' value='13'>
 </div>
 </div>
 <div class='form-row'>
 <div class='col-md-12'>
 ...
 Veuillez corriger votre erreur et réessayer.
 </div>
 </div>
 </div>
 </form>
