        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <div class="container">
                <ul class="nav navbar-nav">
                        ...
                        <li><a class="liens" href="{{route('pages.index')}}#evenements" >{{ trans('nav.evenements') }}</a></li>
                        <li><a class="liens" href="{{route('photos')}}" >{{ trans('nav.photos') }}</a></li>
                        <li><a class="liens" href="{{route('videos')}}" >{{ trans('nav.videos') }}</a></li>
                        <li><a class="liens" href="{{route('pages.index')}}#biographie">{{ trans('nav.bio') }}</a></li>
                        <li><a class="liens" href="{{route('articles')}}" >{{ trans('nav.presse') }}</a></li>
                        <li><a class="liens" href="{{route('pages.index')}}#contact" >{{ trans('nav.contact') }}</a></li>
                </ul>
